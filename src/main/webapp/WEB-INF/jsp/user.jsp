<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-light b-primary">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand c-primary" href="#">Blitz Researches</a>
                    <a class="nav-item btn text-light font-weight-bolder active border-bottom border-right rounded-0" href="/user/vote">Vote</a>
                    <a class="nav-item btn text-light font-weight-bolder  border-bottom border-right rounded-0" href="/user/live_results">Live Results</a>
                </div>
